...
var EosTokenTestnet = (function (_super) {
    __extends(EosTokenTestnet, _super);
    function EosTokenTestnet(ethEngine) {
        return _super.call(this, tokenconfig_1.TokenConfig.Eos.contractAddress, ethEngine) || this;
    }
    return EosTokenTestnet;
}(dex_1.DEX));
exports.EosTokenTestnet = EosTokenTestnet;
var EosTokenMainnet = (function (_super) {
    __extends(EosTokenMainnet, _super);
    function EosTokenMainnet(ethEngine) {
        return _super.call(this, tokenconfigmain_1.TokenConfigMain.Eos.contractAddress, ethEngine) || this;
    }
