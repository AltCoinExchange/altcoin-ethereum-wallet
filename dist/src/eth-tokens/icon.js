...
var ICONTokenTestnet = (function (_super) {
    __extends(ICONTokenTestnet, _super);
    function ICONTokenTestnet(ethEngine) {
        return _super.call(this, tokenconfig_1.TokenConfig.ICON.contractAddress, ethEngine) || this;
    }
    return ICONTokenTestnet;
}(dex_1.DEX));
exports.ICONTokenTestnet = ICONTokenTestnet;
var ICONTokenMainnet = (function (_super) {
    __extends(ICONTokenMainnet, _super);
    function ICONTokenMainnet(ethEngine) {
        return _super.call(this, tokenconfigmain_1.TokenConfigMain.ICON.contractAddress, ethEngine) || this;
    }
