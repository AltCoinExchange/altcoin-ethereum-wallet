...
var RequestNetworkTokenTestnet = (function (_super) {
    __extends(RequestNetworkTokenTestnet, _super);
    function RequestNetworkTokenTestnet(ethEngine) {
        return _super.call(this, tokenconfig_1.TokenConfig.RequestNetwork.contractAddress, ethEngine) || this;
    }
    return RequestNetworkTokenTestnet;
}(dex_1.DEX));
exports.RequestNetworkTokenTestnet = RequestNetworkTokenTestnet;
var RequestNetworkTokenMainnet = (function (_super) {
    __extends(RequestNetworkTokenMainnet, _super);
    function RequestNetworkTokenMainnet(ethEngine) {
        return _super.call(this, tokenconfigmain_1.TokenConfigMain.RequestNetwork.contractAddress, ethEngine) || this;
    }
