...
var AragonTokenTestnet = (function (_super) {
    __extends(AragonTokenTestnet, _super);
    function AragonTokenTestnet(ethEngine) {
        return _super.call(this, tokenconfig_1.TokenConfig.Aragon.contractAddress, ethEngine) || this;
    }
    return AragonTokenTestnet;
}(dex_1.DEX));
exports.AragonTokenTestnet = AragonTokenTestnet;
var AragonTokenMainnet = (function (_super) {
    __extends(AragonTokenMainnet, _super);
    function AragonTokenMainnet(ethEngine) {
        return _super.call(this, tokenconfigmain_1.TokenConfigMain.Aragon.contractAddress, ethEngine) || this;
    }
