...
var DentTokenTestnet = (function (_super) {
    __extends(DentTokenTestnet, _super);
    function DentTokenTestnet(ethEngine) {
        return _super.call(this, tokenconfig_1.TokenConfig.Dent.contractAddress, ethEngine) || this;
    }
    return DentTokenTestnet;
}(dex_1.DEX));
exports.DentTokenTestnet = DentTokenTestnet;
var DentTokenMainnet = (function (_super) {
    __extends(DentTokenMainnet, _super);
    function DentTokenMainnet(ethEngine) {
        return _super.call(this, tokenconfigmain_1.TokenConfigMain.Dent.contractAddress, ethEngine) || this;
    }
