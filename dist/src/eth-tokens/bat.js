...
var BatTokenTestnet = (function (_super) {
    __extends(BatTokenTestnet, _super);
    function BatTokenTestnet(ethEngine) {
        return _super.call(this, tokenconfig_1.TokenConfig.Bat.contractAddress, ethEngine) || this;
    }
    return BatTokenTestnet;
}(dex_1.DEX));
exports.BatTokenTestnet = BatTokenTestnet;
var BatTokenMainnet = (function (_super) {
    __extends(BatTokenMainnet, _super);
    function BatTokenMainnet(ethEngine) {
        return _super.call(this, tokenconfigmain_1.TokenConfigMain.Bat.contractAddress, ethEngine) || this;
    }
