...
var EthereumWallet = (function () {
    function EthereumWallet(configuration) {
        ...
        this.engine = new eth_engine_1.EthEngine(null, this.appConfiguration, null);
    }
    ...
    EthereumWallet.prototype.recoverAccountFromSeed = function (pkSeed) {
        return this.engine.recoverAccountFromSeed(pkSeed);
    };
    EthereumWallet.prototype.generateMnemonic = function () {
        return bip39.generateMnemonic();
    };
    EthereumWallet.prototype.mnemonicToSeed = function (mnemonic) {
